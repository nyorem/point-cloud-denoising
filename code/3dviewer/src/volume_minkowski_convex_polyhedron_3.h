#ifndef _VOLUME_MINKOWSKI_CONVEX_POLYHEDRON_3_H_
#define _VOLUME_MINKOWSKI_CONVEX_POLYHEDRON_3_H_
...
#include <iterator>
#include "volume_minkowski_convex_polyhedron_utils_3.h"

// Compute the volume of the intersection of a Voronoi cell and
// a convex polyhedron.
...
template < typename FT,
         ...
         >
FT volume_voronoi_cell_convex_polyhedron_3 (DT const& dt,
    ...
    FT vol = signed_volume_polyhedron_3<FT>(P);

    return vol;
}

// Compute the volume of the Minkowski sum of a point cloud
...
template < typename FT,
           ...
           typename VectorIterator
         >
FT volume_minkowski_convex_polyhedron_3 (PointIterator pbegin,
    ...
    for (typename DT::Finite_vertices_iterator vit = dt.finite_vertices_begin();
        ...
        vol += volume_voronoi_cell_convex_polyhedron_3<FT>(dt, Vertex_handle(vit),
                                                           polybegin,
                                                           polybeyond,
                                                           radius);
    }
...
// Same as `volume_minkowski_convex_polyhedron_3` but outputs an Eigen vector
// containing for each index i the volume of the ith voronoi cell intersected
...
template < typename FT,
           ...
           typename VectorIterator
         >
Vector volume_minkowski_convex_polyhedron_vector_out_3 (PointIterator pbegin,
                                                        PointIterator pbeyond,
                                                        VectorIterator polybegin,
                                                        VectorIterator polybeyond,
                                                        double radius) {
    ...
    for (typename DT::Finite_vertices_iterator vit = dt.finite_vertices_begin();
        ...
        val[i++] = volume_voronoi_cell_convex_polyhedron_3<FT>(dt, Vertex_handle(vit),
                                                               polybegin,
                                                               polybeyond,
                                                               radius);
    }
...
// Same as `volume_minkowski_convex_polyhedron_3` but takes a vector in argument
...
template < typename FT,
           ...
           typename VectorIterator
         >
FT volume_minkowski_convex_polyhedron_vector_in_3 (Vector points,
                                                   VectorIterator polybegin,
                                                   VectorIterator polybeyond,
                                                   double radius) {
    std::list<Point> vec;
    ...
    return volume_minkowski_convex_polyhedron_3<FT>(vec.begin(), vec.end(),
                                                    polybegin, polybeyond,
                                                    radius);
}

// Same as `volume_minkowski_convex_polyhedron_3` but takes an Eigen vector
...
template < typename FT,
           ...
           typename VectorIterator
          >
Vector volume_minkowski_convex_polyhedron_vector_in_out_3 (Vector points,
                                                           VectorIterator polybegin,
                                                           VectorIterator polybeyond,
                                                           double radius) {
    std::list<Point> vec;
    ...
    return volume_minkowski_convex_polyhedron_vector_out_3<FT, Vector>(vec.begin(), vec.end(),
                                                                       polybegin, polybeyond,
                                                                       radius);
}
...
struct UnionPolyhedra {
    UnionPolyhedra (double radius) : m_radius(radius) {
    }
    ...
    FTAD operator() (PointIterator pbegin, PointIterator pbeyond,
        ...
        m_values = volume_minkowski_convex_polyhedron_vector_in_out_3<FTAD, PointAD>(container_to_vector<VectorAD>(pbegin, pbeyond),
                                                                                     vbegin, vbeyond,
                                                                                     m_radius);
