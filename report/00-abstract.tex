...
introduction, then we will focus on the state of the art related techniques on
smoothing and geometric flows.  Moreover, we will start by studying the two
dimensional case with the $r$-offset of a point cloud. We will continue by
dealing with the 3D case with a polyhedral norm.
