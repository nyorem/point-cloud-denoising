% TODO: talk about inclusion-exclusion computation time

% inlusion-exclusion: comparaison nuage de points
...
% {{{2 AUTOMATIC DIFFERENTIAZTION INTEGRATION
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.2]{3d/fandisk-normals}
    \includegraphics[scale=0.2]{3d/fin90-normals}
