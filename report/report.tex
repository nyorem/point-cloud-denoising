...
\date{$ 26^{th} $ June 2015} % Delete this line to display the current date
\jury{
...
\input{C-3d.tex}
\input{D-theory.tex}
\input{E-conclusion.tex}

\backmatter
\appendix

% Appendix
\input{appendix-A-AD.tex}
\input{appendix-B-code-intersection.tex}
\input{appendix-C-voronoi-polyhedral-norm.tex}
